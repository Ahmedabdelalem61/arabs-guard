...
- Fixed router-validation volunteer URI and bilingual catalog-card assertions, including IPv4/MAC/assignment-pattern exclusion and compact-device large-text layout coverage.
